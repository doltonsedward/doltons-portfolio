...
export const TALKS_DATA: TalkDataTypes[] = [
  ...
  {
    id: 'km-cycle4-frontend',
    title: 'Kampus Merdeka Cycle 4: Front-End Web Development',
    shortDesc:
      'Bootcamp 3 bulan untuk menguasai front-end development dengan HTML, CSS, dan JavaScript modern.',
    description:
      'Program Kampus Merdeka Cycle 4 fokus pada Front-End Web Development. Peserta akan mengikuti pembelajaran intensif selama 3 bulan, terdiri dari sesi live learning (2 jam tiap sesi) dan mentoring sesuai jadwal mentor. Kurikulum mencakup HTML, CSS, JavaScript, dan framework front-end modern, ditutup dengan proyek akhir sebagai portofolio.',
    type: 'bootcamp',
    datetime: '2023-01-16T19:00:00',
    endDatetime: '2030-12-31T19:00:00',
    duration: 7776000, // 90 hari dalam detik
    audience: 'Mahasiswa Skilvul x Kampus Merdeka',
    platform: 'Skilvul LMS + Live Zoom',
    registrationUrl: 'https://skilvul.com/daftar/km-cycle4-frontend',
    topics: ['Front-End Development', 'HTML', 'CSS', 'JavaScript'],
    bannerImage:
      'https://assets.skilvul.com/programs/details-1674182649000.jpg',
    cardImage: 'https://assets.skilvul.com/programs/details-1674182649000.jpg',
    bannerAlt: 'Bootcamp Front-End Web Development Kampus Merdeka Cycle 4',
    attendees: 150,
  },
  {
    id: 'km-cycle4-backend',
    title: 'Kampus Merdeka Cycle 4: Back-End Web Development',
    shortDesc:
      'Bootcamp 3 bulan untuk memahami server-side programming dan database management.',
    description:
      'Program Kampus Merdeka Cycle 4 untuk Back-End Web Development membekali peserta dengan skill server-side programming, API, dan database management. Terdiri dari 3 bulan pembelajaran dengan sesi live learning (2 jam tiap sesi) dan mentoring sesuai kebutuhan. Proyek akhir memastikan peserta siap menghadapi tantangan industri.',
    type: 'bootcamp',
    datetime: '2023-01-16T19:00:00',
    endDatetime: '2030-12-31T19:00:00',
    duration: 7776000,
    audience: 'Mahasiswa Skilvul x Kampus Merdeka',
    platform: 'Skilvul LMS + Live Zoom',
    registrationUrl: 'https://skilvul.com/daftar/km-cycle4-backend',
    topics: ['Back-End Development', 'Node.js', 'Databases', 'API'],
    bannerImage: 'https://assets.skilvul.com/programs/1674182409000.jpg',
    cardImage: 'https://assets.skilvul.com/programs/1674182409000.jpg',
    bannerAlt: 'Bootcamp Back-End Web Development Kampus Merdeka Cycle 4',
    attendees: 50,
  },
  {
    id: 'km-cycle5-fullstack',
    title: 'Kampus Merdeka Cycle 5: Full-Stack Web Development',
    shortDesc:
      'Bootcamp 3 bulan untuk menguasai pengembangan web full-stack dari front-end hingga back-end.',
    description:
      'Program Kampus Merdeka Cycle 5 dirancang untuk mempersiapkan mahasiswa menjadi Full-Stack Web Developer. Pembelajaran berlangsung 3 bulan, dengan live learning (2 jam tiap sesi) dan mentoring. Kurikulum mencakup front-end, back-end, integrasi API, deployment, dan best practice industri.',
    type: 'bootcamp',
    datetime: '2023-05-26T19:00:00',
    endDatetime: '2025-12-31T19:00:00',
    duration: 7776000,
    audience: 'Mahasiswa Skilvul x Kampus Merdeka',
    platform: 'Skilvul LMS + Live Zoom',
    registrationUrl: 'https://skilvul.com/daftar/km-cycle5-fullstack',
    topics: ['Full-Stack Development', 'Front-End', 'Back-End', 'API'],
    bannerImage: 'https://assets.skilvul.com/programs/1685425003000.jpg',
    cardImage: 'https://assets.skilvul.com/programs/1685425003000.jpg',
    bannerAlt: 'Bootcamp Full-Stack Web Development Kampus Merdeka Cycle 5',
    attendees: 100,
  },
  {
    id: 'km-cycle5-uiux',
    title: 'Kampus Merdeka Cycle 5: UI/UX Design',
    shortDesc:
      'Bootcamp 3 bulan untuk memahami UI/UX design, research, dan prototyping.',
    description:
      'Program Kampus Merdeka Cycle 5 fokus pada UI/UX Design, memberikan pengalaman intensif selama 3 bulan. Peserta akan belajar dasar desain antarmuka, UX research, wireframing, dan prototyping dengan tools industri. Tersedia sesi live learning (2 jam tiap sesi) serta mentoring untuk mendukung pengembangan keterampilan praktis.',
    type: 'bootcamp',
    datetime: '2023-05-26T19:00:00',
    endDatetime: '2025-12-31T19:00:00',
    duration: 7776000,
    audience: 'Mahasiswa Skilvul x Kampus Merdeka',
    platform: 'Skilvul LMS + Live Zoom',
    registrationUrl: 'https://skilvul.com/daftar/km-cycle5-uiux',
    topics: ['UI Design', 'UX Research', 'Prototyping', 'Design Thinking'],
    bannerImage: 'https://assets.skilvul.com/programs/1685425017000.jpg',
    cardImage: 'https://assets.skilvul.com/programs/1685425017000.jpg',
    bannerAlt: 'Bootcamp UI/UX Design Kampus Merdeka Cycle 5',
    attendees: 350,
  },
  {
