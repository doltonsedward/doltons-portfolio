        ...
        <div className="space-y-8">
          <div className="bg-[#2a2a2a] rounded-lg p-8 hover:bg-[#2f2f2f] transition-colors duration-300">
            <div className="flex items-start space-x-4">
              <div className="w-3 h-3 bg-[#ffda6b] rounded-full mt-2 flex-shrink-0"></div>
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-[#ffda6b] font-medium">Dec 15, 2024</span>
          ...
          <div className="bg-[#2a2a2a] rounded-lg p-8 hover:bg-[#2f2f2f] transition-colors duration-300">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-[#ffda6b] font-medium">Nov 28, 2024</span>
                  <span className="text-[#a0a0a0]">•</span>
          ...
          <div className="bg-[#2a2a2a] rounded-lg p-8 hover:bg-[#2f2f2f] transition-colors duration-300">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-[#ffda6b] font-medium">Oct 20, 2024</span>
                  <span className="text-[#a0a0a0]">•</span>
