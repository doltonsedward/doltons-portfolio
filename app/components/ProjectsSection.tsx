      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3, 4, 5, 6].map((project) => (
            <Card
              key={project}
              className="group hover:shadow-xl transition-all duration-300 bg-[#2a2a2a] border-[#3a3a3a] hover:border-[#ffda6b]"
            >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex space-x-2">
                    <span className="px-3 py-1 bg-[#ffda6b] text-[#1a1a1a] text-xs font-medium rounded-full">
                      React
                    </span>
                  ...
                  <div className="flex space-x-2">
                    <Button variant="ghost" size="sm" className="text-[#a0a0a0] hover:text-[#ffda6b] p-2">
